...
// Asumiendo que inventario.routes.js está en src/routes/ y el archivo de test está en src/test/
...
describe('inventario.routes.js', () => {
    ...
    describe('POST /inventario', () => {
        ...
        test('Debería devolver 400 si faltan campos requeridos', async () => {
            const incompleteInventario = { cantidad_disponible: 10 }; // Faltan unidad_medida, fecha_actualizacion, alerta_stock
