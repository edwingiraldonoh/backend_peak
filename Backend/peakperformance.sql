...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-07-2025 a las 23:07:50
...
(1, 1, 1, 3.8, 'Se puede hacer mejor el trabajo en comun', '2025-07-10'),
(2, 2, 2, 4.5, 'Buen servicio', '2025-07-10'),
(3, 1, 1, 3.8, 'Se puede mejorar', '2025-07-10'),
(4, 1, 1, 5, 'Excelente', '2025-07-10'),
(5, 1, 1, 3.8, 'Se puede mejorar', '2025-07-10');
...
(1, 1, '2023-12-24', 'Efectivo', 0, 18, 'Digital'),
(3, 1, '2023-12-24', 'Efectivo', 0, 18, 'No desea factura');
...
(1, 1, '2025-06-04', 'Faltan verduras.');
...
(1, 1, 300, 'unidades', '2025-06-04', 'Falta papas');
...
(1, 1, 1, 'El pedido puede tardar un poco mas', '2025-07-10', 'Visto', 'Mesero');
...
(1, 1, 1, 1, '2025-07-09', 'En preparacion', 1, '2025-07-11 13:30:55', 'Plato Tipico', 'En proceso de entrega', 50000),
(2, 2, 2, 2, '2025-07-10', 'Entregado', 1, '2025-07-10 13:38:20', 'Pedido plato regional, entregado', 'Terminado', 55000),
(3, 1, 1, 1, '2025-01-01', 'Enplatando el pedido', 2, '2025-01-01 08:35:35', 'Plato Tipico', 'Faltan 10 minutos para la entraga', 95000);
...
(2, 'Plato Regional', 'Plato tipico regional', 50000, 55, 'Plato');
...
(1, 'Carlos', 'Perez', 'activo', 'cliente', '123456789', 'carlos@gmail.com', '3222222222', '2025-06-04', '0000-00-00'),
(2, 'Maria', 'Perez', 'Activo', 'Mesero', '12345678', 'maria@gmail.com', '3222222222', '0000-00-00', '0000-00-00');
...
(1, 1, '0000-00-00', 0, 'Carleto', 0),
(2, 2, '0000-00-00', 0, 'Andres', 0);
...
--
ALTER TABLE `encuesta_satisfaccion`
  MODIFY `id_encuesta` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `informe_inventario`
  MODIFY `id_informe` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `inventario`
--
ALTER TABLE `inventario`
  MODIFY `id_inventario` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `notificacion`
--
ALTER TABLE `notificacion`
  MODIFY `id_notificacion` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
